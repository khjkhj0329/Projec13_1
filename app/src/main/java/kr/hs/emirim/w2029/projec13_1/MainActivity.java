package kr.hs.emirim.w2029.projec13_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File[] listFlies = new File(musicPath).listFiles();
        Log.i("파일길이", listFlies.length+"");
        Log.i("파일이름", listFlies[0].getName()+"");
        String fileName, extName;
        for (File file : listFlies){ //enhanced  For(개선된 For문)
